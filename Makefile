...
install:
	...
	cd src/implementations/quic-implementations/; git clone https://github.com/AnonymousSEMA/picoquic.git; cd picoquic; git submodule update --init --recursive; cd ..; git clone https://github.com/h2o/picotls.git; cd picotls; git submodule update --init --recursive
