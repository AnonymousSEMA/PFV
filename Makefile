...
install:
	...
	cd src/; git clone https://github.com/AnonymousSEMA/Protocols-Ivy.git; cd Protocols-Ivy; mkdir submodules; cd submodules; git clone https://github.com/h2o/picotls.git; git clone https://github.com/kenmcmil/z3.git
